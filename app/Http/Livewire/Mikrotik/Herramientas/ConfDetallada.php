...
class ConfDetallada extends Component
{
    ...
    public function ejecutarTarea($iface, $index, $tarea)
    {
        ...
        $cmds = [
            ...
            'portal' => ":do { /file remove [find name=\"hotspot/login.html\"] } on-error={}; /ip hotspot profile set [find name=\"hsprof1\" or name=\"hsprof-$iface\"] html-directory=hotspot; :delay 2s; /tool fetch url=\"$downloadUrl\" dst-path=\"hotspot/login.html\" check-certificate=no",
