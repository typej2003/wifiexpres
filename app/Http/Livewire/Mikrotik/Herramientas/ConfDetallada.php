...
class ConfDetallada extends Component
{
    ...
    public function ejecutarTarea($iface, $index, $tarea)
    {
        ...
        $this->taskResult[$iface][$tarea] = 'Validando dependencias...';
        ...
        // LÓGICA DE COMANDOS CON VERIFICACIÓN DE PERFILES
        $cmds = [
            ...
            'hotspot' => "{
                :if ([:len [/ip hotspot profile find name=\"hsprof1\"]] = 0) do={ 
                    /ip hotspot profile add dns-name=wifi.login name=hsprof1 login-by=http-chap,http-pap,trial;
                };
