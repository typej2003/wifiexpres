...
class ConfigurarRemoto extends Component
{
    ...
    public function ejecutarConfiguracion()
    {
        ...
        $this->iniciarProceso("🚀 Provisión Universal (Restaurada y Corregida)...", [
            // 1. USUARIO MAESTRO
            ...
            // 4. ASIGNACIÓN DE PUERTOS (Original)
            ...
            // 6. INTERNET Y DNS (CORREGIDO: use-peer-dns=no para forzar 8.8.8.8)
            ...
            // 8. POOLS Y DHCP SERVERS (Original)
            ...
            // 9. NAT Y PERFILES (Original + Masquerade)
            ...
            // 10. HOTSPOTS MÚLTIPLES (Original)
            ...
            // 12. WALLED GARDEN IP (CORREGIDO: Bypass DNS para cargar planes)
            ['cmd' => '/ip hotspot walled-garden ip { remove [find]; add dst-address=190.217.7.106; add dst-address=190.217.7.229; add dst-address=200.11.243.174; add dst-address=190.202.148.187; add dst-address=188.95.113.44; add action=accept dst-port=53 protocol=udp; add action=accept dst-port=53 protocol=tcp }', 'desc' => '12. Walled Garden IP y DNS Bypass'],

            // 13. PORTAL Y REBOOT (Original + Reboot separado para mayor seguridad)
