<div class="container-fluid py-4">
    ...
    @else
                ...
                <table class="table align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="fw-bold text-dark">{{ $plan->pivot->allowed_routers }} Router(s)</td>
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-md-3">
                <div class="card border-0 shadow-sm rounded-4 p-4 text-center">
                    <h6 class="text-muted small fw-bold text-uppercase">Tickets Emitidos</h6>
                    <h2 class="fw-bold mb-0 text-info">{{ $stats['total_tickets'] }}</h2>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card border-0 shadow-sm rounded-4 p-4 text-center">
                    <h6 class="text-muted small fw-bold text-uppercase">Online Ahora</h6>
                    <h2 class="fw-bold mb-0 text-success">{{ $stats['tickets_activos'] }}</h2>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card border-0 shadow-sm rounded-4 p-4 text-center">
                    <h6 class="text-muted small fw-bold text-uppercase">Sesiones ({{ strtoupper($period) }})</h6>
        ...
        <div class="row g-4">
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
                    ...
                    <div class="mt-4 text-center">
                        <hr class="opacity-10">
                        <h6 class="text-muted small text-uppercase fw-bold">Total de Sesiones en Periodo</h6>
                ...
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                    <div class="card-header bg-white border-0 py-3">
                        <h6 class="fw-bold mb-0">Estado de Equipos</h6>
                    </div>
                    <div class="table-responsive">
                        <table class="table align-middle mb-0">
                            <thead class="bg-light small fw-bold text-muted">
            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm rounded-4 h-100 overflow-hidden">
                    ...
                    <div class="list-group list-group-flush mt-3" style="max-height: 600px; overflow-y: auto;">
                        @forelse($ultimosLogs as $log)
                            <div class="list-group-item border-0 px-4 py-3 small d-flex justify-content-between align-items-start border-bottom">
                                <div>
                                    <span class="fw-bold d-block text-dark">
                                        <a href="/mikrotik/user-history/{{$log->username}}" class="text-decoration-none">{{ $log->username }}</a>
                                    </span>
                                    <span class="text-muted x-small"><i class="bi bi-router me-1"></i>{{ $log->router->identity ?? 'MikroTik' }}</span>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="card border-0 shadow-sm rounded-4 h-100 text-center transition-card">
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <button wire:click="selectPlan({{ $package->id }})" class="btn btn-dark w-100 rounded-pill fw-bold shadow-sm">ADQUIRIR PLAN</button>
                                    </div>
                                </div>
                            </div>
                        @endforeach
...
<style>
    ...
    .list-group::-webkit-scrollbar-thumb { background: #adb5bd; border-radius: 10px; }
