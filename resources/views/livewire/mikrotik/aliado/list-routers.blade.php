<div class="container-fluid py-4" wire:poll.20s="refreshStatus">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted small mb-0">Aliado: <b>{{ auth()->user()->names }}</b></p>
        </div>
    ...
    <div class="row">
                    ...
                    <div class="card-body p-4 pt-5">
                        <div class="d-flex align-items-center mb-3 mt-2"> 
                            ...
                            <div class="overflow-hidden">
                                ...
                                <span class="badge bg-primary bg-opacity-10 text-primary rounded-pill mb-1" style="font-size: 0.7rem;">
                                    <i class="bi bi-box-seam me-1"></i> {{ $r->package->name ?? 'Plan No Encontrado' }}
                                </span>
                        ...
                        <div class="p-3 bg-light rounded-4 mb-3">
                            ...
                            <div class="d-flex justify-content-between small">
                                ...
                                <span class="fw-bold text-truncate text-dark ms-2">{{ $r->location ?: 'Sin ubicación' }}</span>
                            </div>
                        </div>
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-12">
                                ...
                                class="btn btn-primary btn-sm w-100 rounded-pill fw-bold {{ !$online ? 'disabled opacity-50' : '' }}">
                                    <i class="bi bi-ticket-perforated me-1"></i> GESTIONAR TICKETS
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        @empty
            <div class="col-12 text-center py-5">
                ...
                <h6 class="text-muted mt-3">Aún no has registrado ningún equipo MikroTik.</h6>
            </div>
        @endforelse
    </div>
            ...
            <div class="modal-content shadow-lg border-0 rounded-4">
                <div class="modal-header bg-dark text-white p-4">
                    <h5 class="modal-title fw-bold">
                        {{ $router_id ? 'ACTUALIZAR EQUIPO' : 'NUEVO REGISTRO' }}
                    </h5>
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="bg-primary bg-opacity-10 p-3 rounded-4 border-start border-4 border-primary">
                                <label class="form-label small fw-bold text-primary mb-1">MEMBRESÍA ADQUIRIDA</label>
                                <select wire:model="package_id" class="form-select border-0 shadow-sm">
                                    <option value="">-- Seleccionar Plan Contratado --</option>
                        ...
                        <div class="col-md-6 mt-3">
                            <label class="form-label small fw-bold text-muted">IDENTIFICADOR (MIKROTIK)</label>
                            <input type="text" wire:model.defer="identity" class="form-control" placeholder="Ej: Router Plaza">
                        </div>

                        <div class="col-md-6 mt-3">
                            <label class="form-label small fw-bold text-muted">DIRECCIÓN MAC</label>
                            <input type="text" wire:model.defer="macAddress" class="form-control" placeholder="00:00:00:00:00:00">
                        </div>

                        <div class="col-12">
                            <label class="form-label small fw-bold text-dark">NOMBRE DEL COMERCIO / LOCAL</label>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" wire:model.defer="location" class="form-control" placeholder="Ej: Av. Principal local 5">
                        </div>
                ...
                <div class="modal-footer bg-light border-0 p-4">
                    <button wire:click="closeModal" class="btn btn-secondary rounded-pill px-4">Cerrar</button>
                    <button wire:click.prevent="store" class="btn btn-primary rounded-pill px-4 fw-bold shadow-sm">
